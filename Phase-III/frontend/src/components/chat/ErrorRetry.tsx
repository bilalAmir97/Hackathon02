 ...
 * Used for handling network errors, authentication failures, and other issues.
 */
...
/**
 * ErrorRetry component for error display and recovery
 */
export function ErrorRetry({ error, onRetry, onDismiss }: ErrorRetryProps) {
  return (
